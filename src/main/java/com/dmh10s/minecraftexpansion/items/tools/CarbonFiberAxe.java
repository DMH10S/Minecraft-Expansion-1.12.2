...
public class CarbonFiberAxe extends ItemAxe implements IHasModel
{
	public CarbonFiberAxe(String name, ToolMaterial material, float damage, float recoveryTime)
	{
