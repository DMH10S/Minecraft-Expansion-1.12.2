...
public class ArmorAluminum extends ItemArmor implements IHasModel
{
	public ArmorAluminum(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
