...
public class ArmorRhondite extends ItemArmor implements IHasModel
{
	public ArmorRhondite(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
