...
public class ArmorLead extends ItemArmor implements IHasModel
{
	public ArmorLead(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
    ...
    {
        if (repair.getItem().equals(ModItems.LEAD_INGOT))
        {
        	return true;
        }
        else
