...
public class ArmorChain extends ItemArmor implements IHasModel
{
	public ArmorChain(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
    ...
    {
        if (repair.getItem().equals(ModItems.CHAIN))
        {
        	return true;
        }
        else
