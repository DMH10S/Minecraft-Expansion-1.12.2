...
public class ArmorCarbonFiber extends ItemArmor implements IHasModel
{
	public ArmorCarbonFiber(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
