...
public class ArmorSteel extends ItemArmor implements IHasModel
{
	public ArmorSteel(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
