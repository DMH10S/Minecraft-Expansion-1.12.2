...
public class ArmorDiamond extends ItemArmor implements IHasModel
{
	public ArmorDiamond(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
    ...
    {
        if (repair.getItem().equals(Items.DIAMOND))
        {
        	return true;
        }
        else
