...
public class ArmorKevlar extends ItemArmor implements IHasModel
{
	public ArmorKevlar(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
    ...
    {
        if (repair.getItem().equals(ModItems.KEVLAR_SHEET))
        {
        	return true;
        }
        else
