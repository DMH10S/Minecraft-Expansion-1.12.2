...
public class ArmorReinforced extends ItemArmor implements IHasModel
{
	public ArmorReinforced(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
    ...
    {
        if (repair.getItem().equals(Blocks.OBSIDIAN))
        {
        	return true;
        }
        else
