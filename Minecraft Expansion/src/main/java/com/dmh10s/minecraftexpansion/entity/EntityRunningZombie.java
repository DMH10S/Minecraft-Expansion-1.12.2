...
public class EntityRunningZombie extends EntityMob
{
    ...
    public EntityRunningZombie(World worldIn)
    {
        super(worldIn);
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(2, new EntityAIRunningZombieAttack(this, 1.0D, false));
    ...
    {
        return SoundsHandler.ENTITY_RUNNING_ZOMBIE_AMBIENT;
    }

    protected SoundEvent getHurtSound(DamageSource damageSourceIn)
    {
        return SoundsHandler.ENTITY_RUNNING_ZOMBIE_HURT;
    }

    protected SoundEvent getDeathSound()
    {
        return SoundsHandler.ENTITY_RUNNING_ZOMBIE_DEATH;
    }
    ...
    {
        return LootTableHandler.RUNNING_ZOMBIE;
    }
