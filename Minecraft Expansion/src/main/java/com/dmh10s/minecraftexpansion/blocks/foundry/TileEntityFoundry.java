...
import com.dmh10s.minecraftexpansion.blocks.coke_furnace.CokeFurnaceRecipes;
...
import com.dmh10s.minecraftexpansion.blocks.coke_furnace.TileEntityCokeFurnace.Slots;
...
public class TileEntityFoundry extends TileEntity implements ITickable
{
    ...
    private int totalCookTime=1200;
    ...
    public static int getItemBurnTime(ItemStack fuel) 
    {
        ...
        else 
        {
            ...
            if(item == ModItems.COKE) return 1200;
...
//same here : 20 is for 20 ticks of cooking                
            {
                this.cookTime = MathHelper.clamp(this.cookTime - 2, 0, 1200);
            }
